...
- 2d60db5: Two new `AgentEvent` variants close the per-envelope lifecycle on the connector surface:
...
- 646d5d4: feat(plugin-sdk): `invocationContext` on the `spawnChildSession` effect
